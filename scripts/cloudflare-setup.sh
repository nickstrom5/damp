...
GITHUB_TXT_DEFAULT="3cfc05f3b9ca3b4ce521c623cffd56"   # from github.com/settings/pages_verified_domains (optional)
...
echo "  4. Delete the damp-setup API token in Cloudflare."
