...
struct PaywallView: View {
    ...
    var body: some View {
        ZStack(alignment: .topLeading) {
            ...
            // Measure rather than guess: on an iPhone SE (and the folded iPhone Duo) the three-step
            // timeline pushes the plan rows behind the pinned button.
    ...
    /// The trial explained. On a short screen the three-step version pushes the plans below the
    /// fold, so it collapses to one line there.
